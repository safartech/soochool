...
//                            alert("Note trop élevée")
        ...
        onClasseChange(classeId){
            ...
            /*let inters = this.inters.find(x=>{
                // console.log(x.classes)
                return  x.classes.find(c=>c.pivot.classe_id==classeId)
                 // return x.pivot.classe_id == classeId
            })
            console.log(inters.length)*/
            this.inters.forEach(i=>{
                this.matieres.push(i.matiere)
            })
