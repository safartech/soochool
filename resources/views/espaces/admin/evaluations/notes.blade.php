...
//           $.fn.select2.defaults.set( "theme", "bootstrap" );
    ...
    <template type="text\template" id="notes">
        <div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Liste des Notes d'évaluations |
                        ...
                        <div class="tools">
                            ...
                            <span class="icon mdi mdi-close-circle" @click="clickedEvaluationColumn = {}" data-toggle="tooltip" data-placement="top" title="Fermer les champs de notes"></span>
            ...
            <div id="noting-modal" tabindex="-1" role="dialog" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close"><span class="mdi mdi-close"></span></button>
                        ...
                        <div class="modal-body">
                            <div class="text-center">
                                <div class="text-primary"><span class="modal-main-icon mdi mdi-info-outline"></span></div>
                                <h3>Note</h3>
                                <p>Veuillez saisir la note.<br>-</p>
                                <div class="">
                                    <form action="">
                                        <div class="form-group xs-pt-10">
                                            {{--<label>Note</label>--}}
                                            <input type="number" placeholder="Saisir note" class="form-control">
                                        </div>
                                    </form>
                                </div>
                                <div class="xs-mt-50">
            ...
            <div id="create-modal" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" v-show="isReady" @click="createEvaluation()" data-dismiss="modal" class="btn btn-success md-close">Créer l'évaluation</button>
                            <button type="button"  data-dismiss="modal" class="btn btn-default md-close">Quitter</button>
                        </div>
                    </div>
                </div>
