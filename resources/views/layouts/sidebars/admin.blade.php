                    ...
                    <ul class="sidebar-elements">
                        ...
                        <li class="parent"><a href="#"><i class="icon mdi mdi mdi-layers"></i><span>Bulletins</span></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('bulletins.mg') }}">Bloc. moy. générales</a></li>
                                <li><a href="{{ route('bulletins.appreciations') }}">Appreciations</a></li>
                                <li><a href="{{ route('bulletins.ag') }}">App. générales</a></li>
                                <li><a href="{{ route('bulletins.print') }}">Impression</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="parent"><a href="#"><i class="icon mdi mdi-inbox"></i><span>Messages</span></a>
                            <ul class="sub-menu">
                                <li><a href="{{ route('admin.msg.email') }}">Email</a>
                                </li>
                                <li><a href="{{ route('admin.msg.sms') }}">SMS</a>
                                </li>
                                <li><a href="email-compose.html">Communiqué</a>
                                </li>
                            </ul>
                        </li>
